...
@section('content')
    ...
    <div class="grid grid-cols-2">
        <div class="relative col-start-1">
            <input type="email" class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md pl-3 pr-10 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow" placeholder="Search" />
        ...
        <div class="col-end-7 mr-4 mb-2">
            <a href="/produk/create" class="flex items-center bg-blue-500 hover:bg-blue-500 font-medium rounded-lg text-sm px-6 py-2.5 dark:bg-green-700 dark:hover:bg-green-700 dark:focus:bg-green-900">
    ...
    <div class="mb-8 mr-4 overflow-hidden rounded-lg shadow-xs">
        <div class="w-full overflow-x-auto max-h-[400px] overflow-y-auto">
            <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y dark:bg-white">
                    ...
                    <tr class="text-gray-700 dark:text-black">
                        ...
                        <td class="px-4 py-3">
                                <img class="h-16 w-16 object-cover" src="/images/produk/{{ $data->image }}" alt="Gambar Produk" />
                            </td>
