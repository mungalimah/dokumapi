            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="w-full">
                    ...
                    <select name="category" id="category"
                        ...
                        <option value="Roti Kering" {{ old('category', $produk->category) == 'RK' ? 'selected' : '' }}>Roti Kering</option>
                        <option value="Chiffon Cake" {{ old('category', $produk->category) == 'CC' ? 'selected' : '' }}>Chiffon Cake</option>
                        <option value="Roti Kerumpul" {{ old('category', $produk->category) == 'RKr' ? 'selected' : '' }}>Roti Kerumpul</option>
                        <option value="Brownies" {{ old('category', $produk->category) == 'Br' ? 'selected' : '' }}>Brownies</option>
                    </select>
                </div>
                <div class="w-full">
