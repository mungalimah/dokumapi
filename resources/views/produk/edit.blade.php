            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="w-full">
                    ...
                    <select id="category"
                        ...
                        <option value="RK" {{ old('category', $produk->category) == 'RK' ? 'selected' : '' }}>Roti Kering</option>
                        <option value="CC" {{ old('category', $produk->category) == 'CC' ? 'selected' : '' }}>Chiffon Cake</option>
                        <option value="RKr" {{ old('category', $produk->category) == 'RKr' ? 'selected' : '' }}>Roti Kerumpul</option>
                        <option value="Br" {{ old('category', $produk->category) == 'Br' ? 'selected' : '' }}>Brownies</option>
                    </select>
                </div>
                <div class="w-full">
                ...
                <div>
                    ...
                    <input type="number" name="price" id="price" value="{{old('stock', $produk->stock)}}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
