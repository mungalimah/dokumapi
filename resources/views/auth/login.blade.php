...
<body class="">
    ...
    <div class="flex items-center  justify-center min-h-screen gap-10 bg-gray-50 dark:bg-gray-900">
        ...
        <div class="w-full bg-white rounded-lg shadow border dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
              ...
              <form class="space-y-4 md:space-y-6 needs-validation" novalidate action="/login" method="POST">
                @csrf
                  ...
                  <div class="flex items-center justify-between">
                      <div class="flex items-start">
                          <div class="flex items-center h-5">
                            <input id="remember" name="remember" aria-describedby="remember" type="checkbox" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800" required="">
                          </div>
                          <div class="ml-3 text-sm">
                            <label for="remember" class="text-gray-500 dark:text-gray-300">Remember me</label>
                          </div>
                      </div>
                      <a href="/reset" class="text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">Lupa Kata Sandi?</a>
                  </div>
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Tidak punya akun?? <a href="/register" class="font-medium text-blue-600 hover:underline dark:text-blue-500">Buat Akun</a>
                  </p>
              </form>
          </div>
      </div>
